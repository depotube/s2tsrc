...
def main():
    ...
    parser.add_argument(
        #"--local_file_path", type=str, default="Shea Jensen-9-17-19-1of3_data/testseq2mono.wav"
        "--local_file_path", type=str, default="Shea Jensen-9-17-19-1of3_data/testseq3115to200.wav"
    )
